...
- *Armory*: A local agent workspace built from plain Org files. Armory gives you persistent agents, jobs, conversations, approvals, schedules, task boards, data views, git state, and generated app artifacts without leaving Emacs. It is the structured place where prompts become trackable work, model output becomes reviewable artifacts, and agent activity stays inspectable, auditable, and versionable.

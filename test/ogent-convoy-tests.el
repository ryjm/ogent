...
(ert-deftest ogent-convoy-test-visit-no-issue-at-point ()
  "Test visit-tracked errors when no issue at point."
  (with-temp-buffer
    (ogent-convoy-mode)
    (let ((ogent-convoy--magit-section-available nil))
      (should-error (ogent-convoy-visit-tracked) :type 'user-error))))
...
(ert-deftest ogent-convoy-test-face-active ()
  "Test ogent-convoy-status-active face is defined."
  (should (facep 'ogent-convoy-status-active)))

(ert-deftest ogent-convoy-test-face-complete ()
  "Test ogent-convoy-status-complete face is defined."
  (should (facep 'ogent-convoy-status-complete)))

(ert-deftest ogent-convoy-test-face-tracked-issue ()
  "Test ogent-convoy-tracked-issue face is defined."
  (should (facep 'ogent-convoy-tracked-issue)))
...
(ert-deftest ogent-convoy-test-face-issue-id ()
  "Test ogent-convoy-id face is defined."
  (should (facep 'ogent-convoy-id)))

(ert-deftest ogent-convoy-test-face-issue-title ()
  "Test ogent-convoy-title face is defined."
  (should (facep 'ogent-convoy-title)))
...
(ert-deftest ogent-convoy-test-customization-buffer-name ()
  "Test default buffer name format."
  (should (equal "*Convoy: %s*" ogent-convoy-buffer-name-format)))
...
(ert-deftest ogent-convoy-test-customization-use-unicode ()
  "Test default unicode setting (shared via ogent-ops-style)."
  (should ogent-ops-use-unicode))
...
||||||| parent of 327052a (feat(gastown): wire convoy actions to inspector with dedicated mode (og-nqg))
;;; --- Normalization Stability/Regression ---

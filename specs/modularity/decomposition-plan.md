...
|---|---|---|---|---|---|
| `ogent-ui-armory-core.el` | prelude+custom+const+state+helpers (3 macros, magit gate, section nav, insert helpers) | ~870 | `ogent-ui-armory-core` | external only (cl-lib, org, magit-section eval-and-compile, ogent-armory*, tabulated-list, transient) | — |
...
| `ogent-ui-armory.el` (façade) | Bootstrap (setup-section-keymaps + evil/magit quartet) + provide | ~90 | `ogent-ui-armory` | core + all 9 views | — |

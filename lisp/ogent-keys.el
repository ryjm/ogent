...
;; Declare menu commands (transient prefixes; fileonly: generated by
;; `transient-define-prefix', not findable by check-declare)
(declare-function ogent-navigate "ogent-ui" t t)
...
(declare-function ogent-zen-show-tool-calls "ogent-zen-tools")
...
(declare-function ogent-cabinet-home "ogent-ui-cabinet-home")
...
(declare-function ogent-cabinet-create-agent "ogent-ui-cabinet-agent")
(declare-function ogent-cabinet-create-job "ogent-ui-cabinet-jobs")

...
(defun ogent-armory-data--hidden-file-p (root file)
  "Return non-nil when FILE under ROOT is transient Armory or editor state."
...
(defvar ogent-armory-data-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "C-c c") #'ogent-armory-data-create-page)
    (define-key map "r" #'ogent-armory-data-rename-page)
    (define-key map (kbd "C-c r") #'ogent-armory-data-rename-page)
    (define-key map "m" #'ogent-armory-data-move-page)
    (define-key map (kbd "C-c m") #'ogent-armory-data-move-page)
    (define-key map "D" #'ogent-armory-data-delete-page)
    (define-key map (kbd "C-c D") #'ogent-armory-data-delete-page)
    (define-key map "e" #'ogent-armory-data-export-page)
    (define-key map (kbd "C-c e") #'ogent-armory-data-export-page)
    (define-key map "g" #'ogent-armory-data-refresh)
    (define-key map (kbd "C-c g") #'ogent-armory-data-refresh)

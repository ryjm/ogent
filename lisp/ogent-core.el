...
(declare-function ogent-context-preview "ogent-ui-preview")
;; (fileonly: transient prefixes / macro-generated commands)
(declare-function ogent-prompt-dispatch "ui/ogent-ui" t t)
(declare-function ogent-abort-request "ogent-ui-engine")
(declare-function ogent-retry-request "ogent-ui-engine")
(declare-function ogent-ui--setup-highlight-mode "ogent-ui-format")

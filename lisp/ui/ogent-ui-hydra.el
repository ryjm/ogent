...
;; Generated by `defhydra' at runtime, so unknown at compile time (fileonly).
(declare-function ogent-hydra-navigate/body "ogent-ui-hydra" t t)
(declare-function ogent-hydra-edit/body "ogent-ui-hydra" t t)
(declare-function ogent-hydra-request/body "ogent-ui-hydra" t t)

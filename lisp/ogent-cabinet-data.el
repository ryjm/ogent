...
(defvar ogent-cabinet-data-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "C-c c") #'ogent-cabinet-data-create-page)
    (define-key map "r" #'ogent-cabinet-data-rename-page)
    (define-key map (kbd "C-c r") #'ogent-cabinet-data-rename-page)
    (define-key map "m" #'ogent-cabinet-data-move-page)
    (define-key map (kbd "C-c m") #'ogent-cabinet-data-move-page)
    (define-key map "D" #'ogent-cabinet-data-delete-page)
    (define-key map (kbd "C-c D") #'ogent-cabinet-data-delete-page)
    (define-key map "e" #'ogent-cabinet-data-export-page)
    (define-key map (kbd "C-c e") #'ogent-cabinet-data-export-page)
    (define-key map "g" #'ogent-cabinet-data-refresh)
    (define-key map (kbd "C-c g") #'ogent-cabinet-data-refresh)

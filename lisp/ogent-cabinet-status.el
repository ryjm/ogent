...
(defun ogent-cabinet-status-help ()
  ...
  (with-help-window "*Ogent Cabinet Status Help*"
    ...
    (princ "Evil normal and motion states expose the same Cabinet keys; j/k still move by line and ZZ/ZQ quit.\n")))
...
(defconst ogent-cabinet-status--evil-bindings
  '(("g" ogent-cabinet-status-refresh)
    ("RET" ogent-cabinet-status-visit)
    ("<return>" ogent-cabinet-status-visit)
    ("<kp-enter>" ogent-cabinet-status-visit)
    ("n" ogent-cabinet-status-next-item)
    ("p" ogent-cabinet-status-previous-item)
    ("i" ogent-cabinet-status-open-issues)
    ("G" ogent-cabinet-status-open-gastown)
    ("R" ogent-cabinet-status-run)
    ("m" ogent-cabinet-status-dispatch)
    ("?" ogent-cabinet-status-help)
    ("e" ogent-cabinet-status-edit)
    ("E" ogent-cabinet-status-edit-body)
    ("P" ogent-cabinet-status-open-agent-profile)
    ("J" ogent-cabinet-status-open-agent-jobs)
    ("C" ogent-cabinet-status-create-job)
    ...
    ("h" ogent-cabinet-home)
    ("a" ogent-cabinet-agents)
    ("t" ogent-cabinet-tasks)
    ("c" ogent-cabinet-conversations)
    ("s" ogent-cabinet-search)
    ("A" ogent-cabinet-apps)
    ("q" quit-window)
    ("j" evil-next-line)
    ("k" evil-previous-line)
    ("ZZ" quit-window)
    ("ZQ" quit-window))
  "Evil normal and motion state bindings for Cabinet status buffers.")

(defun ogent-cabinet-status--evil-bind-local (key command)
  "Bind Evil normal and motion state KEY to COMMAND when available."
...
(defun ogent-cabinet-status--evil-local-keys ()
  ...
  (dolist (binding ogent-cabinet-status--evil-bindings)
    (ogent-cabinet-status--evil-bind-local (car binding) (cadr binding))))
